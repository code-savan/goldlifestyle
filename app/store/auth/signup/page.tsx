    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-white">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="text-[32px] font-light tracking-[-0.01em] mb-2">Sign Up</h1>
          <p className="text-[13px] text-black/60">Create an admin account</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-12 pr-4 py-3 border border-black/10 focus:outline-none focus:border-black text-[13px]"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full border border-black/10 focus:outline-none focus:border-black text-[13px]"
                placeholder="••••••••"
        ...
        <p className="mt-6 text-center text-[12px] text-black/50">
          ...
          <Link href="/store/auth/signin" className="underline hover:text-black/60">
            Sign in
          </Link>
        </p>
      </div>
